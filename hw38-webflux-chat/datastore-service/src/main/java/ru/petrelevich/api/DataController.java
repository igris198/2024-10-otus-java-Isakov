...
import ru.petrelevich.service.DataStoreExt;
...
public class DataController {
    ...
    public DataController(DataStoreExt dataStore, Scheduler workerPool) {
    ...
    @GetMapping(value = "/allMsg", produces = MediaType.APPLICATION_NDJSON_VALUE)
